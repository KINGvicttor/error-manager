export const SolutionDetail = () => {
    return (
        <section className="w-screen bg-secondary-white">
            <div className="container mx-auto flex flex-col items-center w-full h-[calc(100vh-80px)] py-10">
                <div className="w-full h-[800px] overflow-y-scroll rounded-b-lg">
                    <div className="flex items-center justify-between bg-primary-blue h-[60px] rounded-t-lg  text-white">
                        <h1 className="ml-4 text-xl"><span>000001</span> - Lorem ipsum dolor sit amet consectetur adipisicing elit.</h1>
                    ...
                    <div className="bg-primary-white h-full p-4 text-black">
                        <p className=" text-lg">Solução:</p>
                        <p className="">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi pariatur odit voluptatibus quisquam, quo architecto totam similique quod, placeat tempora ipsum, in fuga asperiores tenetur alias temporibus quibusdam odio iure.</p>
                    </div>
                </div>
