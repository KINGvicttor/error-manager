            ...
            <div className="container mx-auto flex flex-col justify-center items-center p-10">
                ...
                <div className="w-full flex flex-col items-center justify-start gap-x-10">
                    ...
                    <div className="w-full flex justify-start items-center gap-x-10">
                        {/* Adicionar solução */}
                        <a href="/addSolution">
                            <div className="w-[334px] h-[200px] flex justify-center items-center rounded-lg bg-green-500 shadow-lg text-white cursor-pointer hover:bg-green-500/90">
                        ...
                        <a href="/solutionTable">
                            <div className="w-[334px] h-[200px] flex justify-center items-center rounded-lg bg-primary-blue shadow-lg text-white cursor-pointer hover:bg-primary-blue/90">
                                ...
                                <h1 className="text-2xl font-bold ml-2">Tabela de Sugestões</h1>
                            </div>
                        </a>
                    </div>
                </div>
