                ...
                <div className="w-[600px] h-[400px] flex flex-col justify-start items-center bg-primary-white rounded-lg">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <input
                            ...
                            type="text" name="" id="" pattern="\d*" maxLength={6} placeholder="Digite o código do erro" />
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            className="bg-secondary-white px-3 py-2 border-primary-blue border-2 rounded-lg outline-0"
                            type="text" name="" id="" placeholder="Digite o título do erro:" />
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            className="bg-secondary-white px-3 py-2 border-primary-blue border-2 rounded-lg outline-0"
                            type="text" name="" id="" placeholder="Digite a solução" />
                    </div>
